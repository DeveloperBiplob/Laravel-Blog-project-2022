      ...
      <main class="post blog-post col-lg-8">
        <div class="container">
          <div class="post-single">
            <div class="post-thumbnail"><img src="{{ asset('Frontend') }}/img/blog-post-3.jpeg" alt="..." class="img-fluid"></div>
            <div class="post-details">
              ...
              <div class="post-body">
                ...
                <p> <img src="{{ asset('Frontend') }}/img/featured-pic-3.jpeg" alt="..." class="img-fluid"></p>
